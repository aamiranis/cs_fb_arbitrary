...
axesArea(h,[6 7 5 5]);
plotParm={'markerSize',4,'lineWidth',1,'marker','s','MarkerEdgeColor','b'};
% plotParm={'markerSize',1,'lineWidth',0.01,'marker','.','MarkerEdgeColor','b'};
siz=size(adjMat);
vrtxSiz=1000;
edgeMap=jet;
vrtxMap=summer;
...
%     hE=[hE,plot(x(:),y(:),'color',edgeMap(kk,:))];
    % Draw legend bar
